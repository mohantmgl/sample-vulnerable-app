...
def deserialize_blob(blob):
    ...
    # This only evaluates safe Python literals (strings, numbers, tuples, lists, dicts, booleans, None)
    ...
    try:
        ...
        raise ValueError(f"Invalid input: cannot safely evaluate the provided data - {e}")
